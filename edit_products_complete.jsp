		...
		String new_num="";
             try{
                           ...
                           if(fileName != null) {
							...
							new_num=multi.getParameter("pro_num");
...
//birth email zipcode address1/2 phone interest
        try {
            ...
            String sql = "UPDATE products SET name='"+new_name+"', price="+new_price+", company='"+new_company+"',p_image='"+fileName+"',status='"+new_status+"', content='"+new_content+"' WHERE num = "+new_num;
