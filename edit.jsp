...
<body>
  <%
      out.print(session.getAttribute("name")+ " 회원 정보 수정 ");
  %>
  <br>
  <br>
        <form action="edit_CHECK.jsp" method="post" onsubmit="return input_check_func()">
    ...
    <br>
    <button> 정보수정하기 </button> <input id="reset" name="reset" type="reset" value="초기화">
    </form>
    <script>
